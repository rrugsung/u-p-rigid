...
inline double mpm::material::p(const Eigen::Matrix<double, 6, 1>& stress) {
...
inline double mpm::material::j2(const Eigen::Matrix<double, 6, 1>& stress) {
...
inline double mpm::material::j3(const Eigen::Matrix<double, 6, 1>& stress) {
...
inline double mpm::material::q(const Eigen::Matrix<double, 6, 1>& stress) {
...
//! Compute Lode angle
inline double mpm::material::lode_angle(
    const Eigen::Matrix<double, 6, 1>& stress, const double tolerance) {

  // Compute j2 and j3
  const double j2 = mpm::material::j2(stress);
  const double j3 = mpm::material::j3(stress);
...
inline const Eigen::Matrix<double, 6, 1> mpm::material::dp_dsigma(
    const Eigen::Matrix<double, 6, 1>& stress) {
...
inline const Eigen::Matrix<double, 6, 1> mpm::material::dq_dsigma(
    const Eigen::Matrix<double, 6, 1>& stress) {

  // Compute q
  const double q = mpm::material::q(stress);

  // Compute deviatoric stress
  const auto deviatoric_stress = mpm::material::deviatoric_stress(stress);
...
inline const Eigen::Matrix<double, 6, 1> mpm::material::dj2_dsigma(
    const Eigen::Matrix<double, 6, 1>& stress) {

  // Compute deviatoric stress and put them as jd2 / dsigma
  auto dj2_dsigma = mpm::material::deviatoric_stress(stress);
  dj2_dsigma(3) *= 2.0;
  dj2_dsigma(4) *= 2.0;
  dj2_dsigma(5) *= 2.0;
...
inline const Eigen::Matrix<double, 6, 1> mpm::material::dj3_dsigma(
    const Eigen::Matrix<double, 6, 1>& stress) {
...
inline const Eigen::Matrix<double, 6, 1> mpm::material::dtheta_dsigma(
    const Eigen::Matrix<double, 6, 1>& stress, const double tolerance) {
  ...
  // Compute dj2_dsigma
  const auto dj2_dsigma = mpm::material::dj2_dsigma(stress);
...
inline double mpm::material::pdstrain(
